...
#ifdef VENDOR_EDIT
/*Add by liubin at 20160316 for I2C timeout error*/
#include "mt_i2c.h"
#endif
...
//oppo hufeng modify I2C BUS to 2
...
struct mutex sensor_eeprom_lock;
#endif
...
#ifdef VENDOR_EDIT
/*Add by liubin at 20160316 for I2C timeout error*/
        if (i4RetValue == -ETIMEDOUT_I2C) /*I2C timeout error*/
           break;
#endif
    }
    else {
...
#ifdef VENDOR_EDIT
//jindian.guan 2015/01/10 add for sensor state
int main_sensor_state = 0;
int sub_sensor_state = 0;
#endif
/*******************************************************************************
...
#ifdef VENDOR_EDIT
//jindian.guan 2015/01/10 add for sensor state
        if (ret == ERROR_NONE && DUAL_CAMERA_MAIN_SENSOR == g_CurrentSensorIdx)
            main_sensor_state = 1;
        if (ret == ERROR_NONE && DUAL_CAMERA_SUB_SENSOR == g_CurrentSensorIdx)
            sub_sensor_state = 1;   
#endif
        ...
        if (ERROR_NONE != ret) {
            ...
            PK_ERR("SensorOpen");
#ifdef VENDOR_EDIT
/* oppo liubin 20160317 add for sensor state */
            main_sensor_state = 0;
            sub_sensor_state = 0;
#endif
            return ret;
...
inline static int  adopt_CAMERA_HW_FeatureControl(void *pBuf)
{
	...
	case SENSOR_FEATURE_SET_IMX298_PDFOCUS_AREA:   // add by yfx       
        /*  */
...
#ifdef VENDOR_EDIT
/*oppo hufeng modify as the original code can cause memory error*/
			if (copy_to_user
