...
#ifdef  VENDOR_EDIT       
#Mofei@BasicDrv.Charger, 2015/10/15 add for VENDOR_EDIT_15311   
ifeq ($(OPPO_TARGET_DEVICE),oppo6755_15311)      
KBUILD_CFLAGS +=   -DVENDOR_EDIT_15311
KBUILD_CPPFLAGS += -DVENDOR_EDIT_15311
CFLAGS_KERNEL +=   -DVENDOR_EDIT_15311
CFLAGS_MODULE +=   -DVENDOR_EDIT_15311  
endif         
#endif

#ifdef  VENDOR_EDIT       
#hanqing.wang@EXP.BaseDrv.Audio,2016/02/16 Modify(or Add) for oppo6750_15331 define VENDOR_EDIT_15331 DVENDOR_EDIT_15331
ifeq ($(OPPO_TARGET_DEVICE),oppo6750_15331)      
KBUILD_CFLAGS +=   -DVENDOR_EDIT_15331
KBUILD_CPPFLAGS += -DVENDOR_EDIT_15331
CFLAGS_KERNEL +=   -DVENDOR_EDIT_15331
CFLAGS_MODULE +=   -DVENDOR_EDIT_15331  
endif  

#ifdef VENDOR_EDIT  
#/*xiaohua.tian@Prd6.BaseDrv.Sensor,2016/08/17 add for control for gyroscope
ifeq ($(OPPO_TARGET_DEVICE),oppo6750_15331)
CFLAGS_KERNEL +=   -DAKM_SENSOR_09911
endif
ifeq ($(OPPO_TARGET_DEVICE),oppo6750_16321)
CFLAGS_KERNEL +=   -DAKM_SENSOR_09911
endif
#endif

#ifdef  VENDOR_EDIT       
#zhengjiang.zhu@EXP.BaseDrv.Camera,2016/05/09 add for VENDOR_EDIT_16321
ifeq ($(OPPO_TARGET_DEVICE),oppo6750_16321)      
KBUILD_CFLAGS +=   -DVENDOR_EDIT_16321
KBUILD_CPPFLAGS += -DVENDOR_EDIT_16321
CFLAGS_KERNEL +=   -DVENDOR_EDIT_16321
CFLAGS_MODULE +=   -DVENDOR_EDIT_16321  
endif  
#endif
